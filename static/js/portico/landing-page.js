...
const apps_events = function () {
    ...
    const ELECTRON_APP_URL_LINUX = "https://www.kochartech.com" + ELECTRON_APP_VERSION + "/Zulip-" + ELECTRON_APP_VERSION + "-x86_64.AppImage";
    const ELECTRON_APP_URL_MAC = "https://www.kochartech.com" + ELECTRON_APP_VERSION + "/Zulip-" + ELECTRON_APP_VERSION + ".dmg";
    const ELECTRON_APP_URL_WINDOWS = "https://www.kochartech.com" + ELECTRON_APP_VERSION + "/Zulip-Web-Setup-" + ELECTRON_APP_VERSION + ".exe";

    const info = {
        windows: {
            image: "/static/images/landing-page/microsoft.png",
            alt: "Windows",
            description: "Kochar Tech.",
